<?php /* Smarty version Smarty-3.0.9, created on 2015-05-05 00:34:09
         compiled from "C:/xampp/htdocs/diskitos/templates\ingresarediciones.tpl" */ ?>
<?php /*%%SmartyHeaderCode:100755547f3e19130f7-07575252%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '100755547f3e19130f7-07575252',
  'function' => 
  array (
  ),
...
ingresarediciones.php?option=ingresar" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="col-md-7">
                        <input type="text" name="codigo_de_barras" id="codigo_de_barras" class="form-control input-md chat-input" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="col-md-4">
