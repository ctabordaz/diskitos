<?php /* Smarty version Smarty-3.0.9, created on 2015-06-03 17:02:17
         compiled from "C:/wamp/www/diskitos/templates\buscarediciones2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12148556f16f93bdcd7-81235338%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '12148556f16f93bdcd7-81235338',
  'function' => 
  array (
  ),
...
buscarediciones.php?option=cancionero&album=<?php echo $_smarty_tpl->getVariable('rc')->value->album;?>
','1433123817331','width=700,height=300,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;">Ver Canciones</a>
                        </div> 
                    </div>
                </div>
            </div>
