                        ...
                        <div class="dummy-grid dummy-grid--filled">
                            ...
                            {foreach from=$ediciones item=edicion}
                                ...
                                <div class="dummy-grid__item">
                                    ...
                                    <p id='detalle2'>Cantidad a Pedir: <input type="number" name="cantidad-{$edicion->get('codigo_de_barras')}" min="1"></p>
                                    <p id='detalle2'>Proveedor ............ : <input type="text" name="proveedor-{$edicion->get('codigo_de_barras')}"> </p>
                                </div>
